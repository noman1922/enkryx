        ...
        <div className="mx-auto mt-20 grid grid-cols-1 gap-x-12 gap-y-16 lg:grid-cols-3">
          {data.projects.slice(0, 3).map((project, index) => (
            <div
              ...
              className={`glass-ultra glass-hover-shine group relative overflow-hidden rounded-[2.5rem] transition-all duration-500 hover:scale-[1.05] hover:shadow-glow animate-fade-in-up stagger-${(index % 3) + 1} cursor-pointer`}
            >
